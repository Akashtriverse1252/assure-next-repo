...
import Aboutbanner from "@/public/pharmacy-banner.webp";
import AboutbannerM from "@/public/pharmacy-banner-M.webp";
  ...
  return (
    <>
      <Helmet>
        ...
        />
        <link rel="canonical" href="https://www.assurepathlabs.com/pharmacy" />
      </Helmet>
          ...
          <div className="container">
            <div className="web-container my-2">
              ...
              >
                ...
                <div
                  className="m-auto pt-4 col-12 col-md-10 d-flex justify-content-center flex-direction-row text-center"
                  data-aos="fade-up"
                  data-aos-duration={600}
                  data-aos-once="true"
                  data-aos-anchor-placement="top-bottom"
