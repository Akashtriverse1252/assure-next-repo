...
const LogoDNA = () => {
  ...
  //       // Set initial styles for the stroke
  //       svgElement.style.strokeDasharray = length;
  //       svgElement.style.strokeDashoffset = length;

  //       // Animate the stroke from lower to upper direction
  //       svgElement.animate(
  //         [{ strokeDashoffset: length }, { strokeDashoffset: 0 }],
  //         {
  //           duration: 1000, // Animation duration in milliseconds
  //           easing: "ease-out", // You can use other easing functions
  //         }
  //       );
  //     }
    ...
    <>
      ...
      >
        <g id="Layer_x0020_1">
          ...
          <path
            className="fil0"
            d="M2096.71 676.63l-1216.79 0c-61.55,0 -91.98,74.9 -47.73,117.65 28.52,27.54 58.48,55.52 85.3,80.07 50.15,45.86 115.61,71.1 183.55,71.1l769.85 0c65.6,0 128.88,-23.66 178.48,-66.56 29.21,-25.26 62.2,-54.57 93.73,-83.37 46.08,-42.07 16.06,-118.89 -46.39,-118.89z"
          />
          <path
            className="fil0 string_left"
            d="M455.93 5738.99c19.27,-117.05 63.62,-222.65 127.56,-319.67 64.03,-97.21 147.68,-185.81 245.3,-268.82 95.18,-80.9 203.56,-156.54 320.02,-229.57 58.01,-36.37 55.55,-121.69 -4.23,-155.11 -84.53,-47.22 -169.47,-95.67 -253.81,-146.21 -30.02,-18.01 -67.8,-17.54 -96.83,2.06 -433.88,293.4 -788.83,664.98 -793.88,1239.1 -1.03,118.48 85.45,224.36 203.52,234.15 79.91,6.62 151.66,-29.17 195.81,-87.11 28.49,-37.41 45.59,-83.92 45.59,-134.6 0,-46.43 3.85,-91.07 10.95,-134.22zm1154.51 -4269.92c-302.97,-167.13 -597.3,-329.59 -814.46,-523.62 -92.79,-82.89 -171.44,-171.55 -230.61,-268.82 -59.07,-97.07 -98.82,-202.64 -113.74,-319.67 -4.37,-34.24 -6.65,-69.45 -6.65,-105.7 0,-64.54 -27.62,-122.47 -71.5,-163.12 -39,-36.13 -90.8,-58.62 -147.96,-59.37 -126.37,-1.69 -226.66,109.77 -225.46,236.08 8,828.53 744.91,1235.01 1395.44,1593.87 599.32,330.61 1165.42,642.88 1165.42,1217.79 0,423.54 -307.22,704.53 -708.6,955.27 -58.66,36.65 -56.56,122.71 3.77,156.5 83.98,47.1 168.26,95.42 251.86,145.91 30.2,18.26 68.33,17.91 97.63,-1.79 439.93,-296.25 800.32,-671.82 800.32,-1255.89 0,-837.66 -741.41,-1246.63 -1395.46,-1607.44z"
          />
          <path
            className="fil0"
